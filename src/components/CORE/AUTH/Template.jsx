  ...
  return (
    <div className='w-screen h-screen'>
      <div className='w-full h-full bg-auth-bg bg-cover bg-fixed bg-center bg-no-repeat flex justify-center items-center '>
        <div className='w-fit h-fit flex flex-col gap-4 bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-sm shadow-lg drop-shadow-xl shadow-black'>
          <div>
            <h1 className="text-center text-4xl text-[#d2d2d7] font-bold font-serif">{title}
            </h1>
          </div>
